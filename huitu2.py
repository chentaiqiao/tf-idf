...
plt.scatter(x_new, [tf for _, tf, _ in word_values], label='TF',marker="x",s=1)
plt.scatter(x_new, [idf for _, _, idf in word_values], label='IDF', marker=".",s=1)
